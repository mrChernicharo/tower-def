...
export const ENEMY_BLUEPRINTS: { [k in EnemyType]: EnemyBluePrint } = {
    ...
    raptor: {
        ...
        reward: 10,
        modelURL: "/assets/glb/models/raptoid.glb",
        speed: 4,
        maxHp: 100,
        modelScale: 0.02,
    ...
    soldier: {
        ...
        reward: 15,
        modelURL: "/assets/glb/models/Character_Soldier.gltf",
        speed: 2,
        maxHp: 150,
        modelScale: 1.5,
        walkAnimationName: "Walk",
    ...
    brigand: {
        ...
        reward: 15,
        modelURL: "/assets/glb/models/Character_Hazmat.gltf",
        speed: 2,
        maxHp: 150,
        modelScale: 1.5,
        walkAnimationName: "Walk",
    ...
    warrior: {
        ...
        reward: 15,
        modelURL: "/assets/glb/models/Character_Enemy.gltf",
        speed: 1.6,
        maxHp: 150,
        modelScale: 1.5,
        walkAnimationName: "Walk",
